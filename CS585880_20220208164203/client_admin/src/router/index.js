...
const routes = [
	...
	// 景点分类路由
	{
		path: '/classification_of_scenic_spots/table',
		name: 'classification_of_scenic_spots_table',
		component: () => import('../views/classification_of_scenic_spots/table.vue')
	},
	{
		path: '/classification_of_scenic_spots/view',
		name: 'classification_of_scenic_spots_view',
		component: () => import('../views/classification_of_scenic_spots/view.vue')
	},
	// 注册用户路由
	{
	...
	// 酒店管理路由
	{
		path: '/hotel_management/table',
		name: 'hotel_management_table',
		component: () => import('../views/hotel_management/table.vue')
	},
	{
		path: '/hotel_management/view',
		name: 'hotel_management_view',
		component: () => import('../views/hotel_management/view.vue')
	},
	// 房型管理路由
	{
