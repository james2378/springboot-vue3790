<template>
	<div class="diy_details_box diy_div_classification_of_scenic_spots">
		<div class="warp">
			<div class="container">
		...
		methods: {
			...
			change_praise(obj) {
				...
				var query = {
					...
					source_field: "classification_of_scenic_spots_id",
					source_id: this.obj["classification_of_scenic_spots_id"],
					user_id
				};
				...
				if (this.state_praise) {
					...
					this.$get('~/api/praise/del?', query, (res) => {
						if(res.result){
							...
							this.$post('~/api/classification_of_scenic_spots/set?classification_of_scenic_spots_id=' + _this.obj["classification_of_scenic_spots_id"], {
								praise_len
							}, (res) => {
								if(res.result){
